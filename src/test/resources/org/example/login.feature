Feature: Saucedemo User Login
  ...
  Scenario: Attempting to login with a temporarily disabled account
    Given the home page is opened
    And the 'Username' field is filled with 'disabled_user'
    And the 'Password' field is filled with 'temp_pass'
    When the 'Login' button is clicked
